...
Group.new('PMenuSbar',    c.none,         c.syntax_bg,      no)
Group.new('PMenuThumb',   c.none,         c.mono_1,         no)
Group.new('Question',     c.hue_2,        c.none,           no)
Group.new('Search',       c.syntax_bg,    c.hue_6_2,        no)
...
Group.new('Constant',       c.hue_6,         c.none,      no)
...
Group.new('Identifier',     c.mono_1,        c.none,      no)
...
Group.new('Self',           c.hue_5,         c.none,      italics)
...
-- CSS/Sass
Group.new('cssAttrComma',         c.mono_1,  c.none,  no)
Group.new('cssAttributeSelector', c.hue_4,  c.none,  no)
Group.new('cssBraces',            c.mono_2, c.none,  no)
Group.new('cssClassName',         c.hue_3,  c.none,  no)
Group.new('cssClassNameDot',      c.hue_3,  c.none,  no)
...
Group.new('cssProp',              c.hue_2,  c.none,  no)
...
Group.new('cssAttr',              c.hue_5,  c.none,  no)
...
Group.new('sassProperty',       c.hue_2,    c.none,  no)
Group.new('sassFunction',       c.hue_2,    c.none,  no)
...
Group.new('rustCommentLine',          c.mono_3, c.none, italics)
Group.new('rustCommentLineDoc',       c.mono_3, c.none, italics)
Group.new('rustCommentLineDocError',  c.mono_3, c.none, italics)
Group.new('rustCommentBlock',         c.mono_3, c.none, italics)
Group.new('rustCommentBlockDoc',      c.mono_3, c.none, italics)
Group.new('rustCommentBlockDocError', c.mono_3, c.none, italics)
...
-- Neovim cmp Item kind
Group.new("CmpItemKind", g.Comment)
Group.new("CmpItemKindDefault", g.CmpItemKind)
...
Group.new('TSKeywordOperator',     g.Operator,       g.Operator,       g.Operator)
...
Group.new('TSNamespace',           g.Namespace,      g.Namespace,      g.Namespace)
...
Group.new('TSParameterReference',  g.Identifier,     g.Identifier,     g.Identifier)
...
Group.new('TSStrong',              g.bold,           g.bold,           g.bold)
...
Group.new('TSVariable',            g.Self,           g.Self,           g.Self)
Group.new('TSVariableBuiltin',     g.Self,           g.Self,           g.Self)

-- Link the tree sitter varialbe.builtin to the correct highlighting
